...
ZLG_DLL_PATH = r"C:\Users\e9981231\AppData\Local\Programs\Python\Python35-32\Lib\site-packages\can\interfaces\zlgcan\zlgcan.dll"
...
class ZlgCanAbstractionLayer(object):
    def __init__(self):
        if platform.system() == "Windows":
            self.__dll = windll.LoadLibrary(ZLG_DLL_PATH)
        else:
            log.error("No support now!")
        if self.__dll == None:
            print("DLL couldn't be loaded!")
            log.error('DLL failed to load at path: {}'.format(ZLG_DLL_PATH))

    def OpenDevice(self, device_type, device_index, reserved):
        try:
            return self.__dll.ZCAN_OpenDevice(device_type, device_index, reserved)
        except:
            log.error("Exception on OpenDevice!") 
            raise
    ...
    def CloseDevice(self, device_handle):
        try:
            ...
            log.error("Exception on CloseDevice!")
            raise
    ...
    def GetDeviceInf(self, device_handle):
        try:
            ...
            log.error("Exception on ZCAN_GetDeviceInf")
            raise
    ...
    def DeviceOnLine(self, device_handle):
        try:
            ...
            log.error("Exception on ZCAN_ZCAN_IsDeviceOnLine!")
            raise
    ...
    def InitCAN(self, device_handle, can_index, init_config):
        try:
            ...
            log.error("Exception on ZCAN_InitCAN!")
            raise
    ...
    def StartCAN(self, chn_handle):
        try:
            ...
            log.error("Exception on ZCAN_StartCAN!")
            raise
    ...
    def ResetCAN(self, chn_handle):
        try:
            ...
            log.error("Exception on ZCAN_ResetCAN!")
            raise
    ...
    def ClearBuffer(self, chn_handle):
        try:
            ...
            log.error("Exception on ZCAN_ClearBuffer!")
            raise
    ...
    def ReadChannelErrInfo(self, chn_handle):
        try:
            ...
            log.error("Exception on ZCAN_ReadChannelErrInfo!")
            raise
    ...
    def ReadChannelStatus(self, chn_handle):
        try:
            ...
            log.error("Exception on ZCAN_ReadChannelStatus!")
            raise
    ...
    def GetReceiveNum(self, chn_handle, can_type = ZCAN_TYPE_CAN):
        try:
            ...
            log.error("Exception on ZCAN_GetReceiveNum!")
            raise
    ...
    def Transmit(self, chn_handle, std_msg, len):
        try:
            ...
            log.error("Exception on ZCAN_Transmit!")
            raise
    ...
    def Receive(self, chn_handle, rcv_num, wait_time = c_int(-1)):
        try:
            ...
            log.error("Exception on ZCAN_Receive!")
            raise
    ...
    def TransmitFD(self, chn_handle, fd_msg, len):
        try:
            ...
            log.error("Exception on ZCAN_TransmitFD!")
            raise
    ...
    def ReceiveFD(self, chn_handle, rcv_num, wait_time = c_int(-1)):
        try:
            ...
            log.error("Exception on ZCAN_ReceiveFD!")
            raise
    ...
    def GetIProperty(self, device_handle):
        try:
            ...
            log.error("Exception on ZCAN_GetIProperty!")
            raise
    ...
    def SetValue(self, iproperty, path, value):
        try:
            ...
            log.error("Exception on IProperty SetValue")
            raise
    ...
    def GetValue(self, iproperty, path):
        try:
            ...
            log.error("Exception on IProperty GetValue")
            raise
    ...
    def ReleaseIProperty(self, iproperty):
        try:
            ...
            log.error("Exception on ZCAN_ReleaseIProperty!")
            raise
###############################################################################
'''
USBCANFD-MINI Demo
...
if __name__ == "__main__":
    zcanlib = ZlgCanAbstractionLayer() 
